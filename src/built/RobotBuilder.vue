<template>
  <div>
    <div class="top-row">
      <div class="top part">
        <img :src="availableParts.heads[selectedHeadIndex].src" alt="" :title="Header" />
    ...
    <div class="middle-row">
      <div class="left part">
        <img :src="availableParts.arms[selectedLeftArmIndex].src" title="left arm" alt="" />
      ...
      <div class="right part">
        <img :src="availableParts.arms[selectedRightArmIndex].src" title="left arm" alt="" />
...
export function getNextValidIndex(index, length) {
